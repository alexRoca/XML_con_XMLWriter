<?php
	...
	echo 'CREACIÓN DE XML USANDO XMLWriter <br><br><br><br>';
	...
	echo '* creamos un objeto de la clase XMLWriter <br>';
	$objetoXML = new XMLWriter();

	// Estructura básica del XML
	echo '* configuramos Estructura básica del XML <br>';
	$objetoXML->openURI("obras.xml");
	$objetoXML->setIndent(true);
	$objetoXML->setIndentString("\t");
	$objetoXML->startDocument('1.0', 'utf-8');
	// Inicio del nodo raíz
	echo '* Iniciamos el nodo raíz <br>';
	$objetoXML->startElement("obras");

	echo '* recorremos el array con los datos y armamos los nodos internos <br>';
